...
@section('content')
    <div
        ...
        <div class="intro-y mt-8 flex items-center">
            <h2 class="mr-auto text-lg font-medium">Edit Data Sub Induk</h2>
        </div>
                            ...
                            <div class="preview relative [&.hide]:overflow-hidden [&.hide]:h-0">
                                <div class="input-form mt-3">
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <input data-tw-merge="" value="value="{{ $user->UserProfile->full_name }}"" name="full_name" id="regular-form-1" type="text"
                                ...
                                <div class="input-form mt-3">
                                    <div>
                                        <label>NRP / NIK</label>
                                        <div class="mt-2">
                                            <input data-tw-merge="" name="nrp_nik" value="{{ $user->UserProfile->national_id }}" id="regular-form-1" type="text"
