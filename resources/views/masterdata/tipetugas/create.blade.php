...
@section('content')
    <div
        ...
        <div class="intro-y mt-8 flex items-center">
            <h2 class="mr-auto text-lg font-medium">Tambah Data Tipe Tugas</h2>
        </div>
        <form id="registration-form" action="{{ route('masterdata.tasktype.store') }}" method="POST">
            @csrf
                            ...
                            <div class="preview relative [&.hide]:overflow-hidden [&.hide]:h-0">
                                <div class="input-form">
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <input data-tw-merge="" name="name" id="regular-form-1" type="text"
