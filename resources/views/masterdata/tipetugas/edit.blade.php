...
@section('content')
    <div
        ...
        <div class="intro-y mt-8 flex items-center">
            <h2 class="mr-auto text-lg font-medium">Edit Data Tipe Tugas</h2>
        </div>
        <form id="registration-form" action="{{ route('masterdata.tasktype.update', $taskType->id) }}" method="POST">
            @csrf
                            ...
                            <div class="preview relative [&.hide]:overflow-hidden [&.hide]:h-0">
                                <div class="input-form">
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <input data-tw-merge="" value="{{ $taskType->name }}" name="name" id="regular-form-1" type="text"
                                                placeholder="Isi Nama Tugas"
                                ...
                                <div class="input-form mt-3">
                                    <div>
                                        <label>Induk Tugas</label>
                                        <div class="mt-2">
                                            <select data-placeholder="Pilih Data Induk Tugas" class="tom-select w-full"
                                                name="parent_id">
                                                <option value=""></option>
                                            </select>
                                        </div>
