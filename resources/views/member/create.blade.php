...
@section('content')
    <div
        ...
        <div class="intro-y mt-8 flex items-center">
            <h2 class="mr-auto text-lg font-medium">Tambah Data Anggota</h2>
        </div>
        <form id="registration-form" action="{{ route('management.member.store') }}" method="POST">
            @csrf
