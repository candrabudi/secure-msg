...
@section('content')
    <div
        ...
        <form id="registration-form" class="validate-form">
                            ...
                            <div class="preview relative [&.hide]:overflow-hidden [&.hide]:h-0">
                                ...
                                <div class="input-form mt-3">
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <input data-tw-merge="" id="regular-form-1" type="text"
                                ...
                                <div class="input-form mt-3">
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <textarea data-tw-merge="" id="regular-form-1" type="text" placeholder=""
                                ...
                                <div class="input-form mt-3">
                                    <div>
                                        <label>Urutan</label>
                                        <div class="mt-2">
                                            <input data-tw-merge="" id="regular-form-1" type="number"
                                ...
                                <div class="input-form mt-3">
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <select data-placeholder="Pilih Satgas Struktur" class="tom-select w-full">
                                                <option value=""></option>
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="preview-component intro-y box">
                        ...
                        <div class="p-5">
                            <div class="preview relative [&.hide]:overflow-hidden [&.hide]:h-0">
                                <div class="input-form">
                                    <div>
                                        <label>Tiper User</label>
                                        <div class="mt-2">
                                            <select data-placeholder="Pilih Tipi User" class="tom-select w-full">
                                                <option value=""></option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="input-form mt-3">
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <input data-tw-merge="" id="regular-form-1" type="password"
