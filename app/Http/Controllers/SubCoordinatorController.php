...
class SubCoordinatorController extends Controller
{
    ...
    {
        return view('subcoordinator.index');
    }

    public function getSubCoordinator()
    {
        $subcoordinators = User::where('role_id', 7)
            ->with('UserProfile')
            ->paginate(10);

        return response()->json($subcoordinators);
    }

    public function create()
    {
        return view('subcoordinator.create');
    }
    ...
    public function edit($userid)
    {
        ...
        return view('subcoordinator.edit', compact('user'));
    }
    ...
    public function update($user_id, Request $request)
    {
        try {
            ...
            $suser->status = $request->account_status ?? $suser->account_status;
