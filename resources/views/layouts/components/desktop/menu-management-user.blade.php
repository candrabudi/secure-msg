...
<li>
    <a href="{{ route('management.coordinator') }}"
        class="side-menu {{ request()->routeIs('management.coordinator') || request()->routeIs('management.coordinator.create') ? 'side-menu--active' : '' }}">
        <div class="side-menu__icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-lucide="user" class="lucide lucide-user stroke-1.5 w-5 h-5 mx-auto block"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
        </div>
        <div class="side-menu__title">
...
<li>
    <a href="{{ route('management.subcoordinator') }}"
        class="side-menu {{ request()->routeIs('management.subcoordinator') || request()->routeIs('management.subcoordinator.create') ? 'side-menu--active' : '' }}">
        <div class="side-menu__icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-lucide="user" class="lucide lucide-user stroke-1.5 w-5 h-5 mx-auto block"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
        </div>
        <div class="side-menu__title">
